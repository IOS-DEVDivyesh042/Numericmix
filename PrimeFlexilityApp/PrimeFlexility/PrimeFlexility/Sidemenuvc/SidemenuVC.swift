...
class SidemenuVC: UIViewController {
    ...
    var arraimg = ["button 4","button 4","button 4","button 4","button 4","button 4","button 4","button 4"]
   
    var labelarray = ["Feedback","Share","Privacy","Terms","Help","Rate","ABoutus","Howtouse"]
